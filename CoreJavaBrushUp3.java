...
//creating string by literal
		...
		String s1 = "hello jigyasa"; // here new object s1 will not be creatd insted a pointer will be created which
										// will point to same objt s

//creating string using new 

		String s2 = new String("hello jigyasa");// here new objt will be created each time when you write new even if
												// the string is same
		String s3 = new String("hello jigyasa");

		// splitting a string into parts
		String s4 = "Good afternoon friends";
		// s4.split(" ");// split is a method of string class to split a string into
		// parts
